---
layout: single
title:  "EFK와 ELK Stack로 중앙화된 log 모니터링 체험해보기"
categories: SRE
...
Logstash는 FileBeat에서 수집하고 메타데이터를 얹은 로그를 필터를 통해 파싱하는데요. Logstash 공식 문서를 참고하여 로그 메시지를 아파치 로그 형태로 변환하고 중복되거나 불필요한 필드를 제거하는 식을 다듬고 엘라스틱서치에 output하는 파이프라인 설정 파일 configmap을 작성하고 주입해 주었습니다.
...
<img title="" src="../../images/2025-01-15-centralized-monitoring/2025-01-21-20-46-17-image.png" alt="loading-ag-685" data-align="center">
